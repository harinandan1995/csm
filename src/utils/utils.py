...
def add_train_arguments(sub_parser: argparse.ArgumentParser):
    ...
    sub_parser.add_argument('--train.scale_bias', required=False, type=float)

    sub_parser.add_argument('--train.loss.geometric',
                            required=False, type=float)
    sub_parser.add_argument('--train.loss.visibility',
                            required=False, type=float)
    ...
    sub_parser.add_argument('--train.loss.mask_only',
                            required=False, type=str2bool)
    ...
    sub_parser.add_argument('-lr', '--train.optim.lr',
                            required=False, type=float)
    sub_parser.add_argument('-b1', '--train.optim.beta1',
                            required=False, type=float)


def add_kp_test_arguments(sub_parser: argparse.ArgumentParser):

    sub_parser.add_argument('-b', '--test.batch_size',
                            required=False, type=int)
    sub_parser.add_argument('-s', '--test.shuffle',
                            required=False, type=str2bool)
    ...
    sub_parser.add_argument(
        '--test.alpha', required=False, type=float, nargs='+')
    sub_parser.add_argument('--test.add_summaries',
                            required=False, type=str2bool)
